...
import { InstanceActionsMenu } from "./instance-actions-menu"
import type { DbInstanceStats, DbN8NInstance } from "@/lib/supabase/types"

interface InstanceCardProps {
  instance: DbInstanceStats
  fullInstance?: DbN8NInstance
  onMutated?: () => void
}
...
export function InstanceCard({ instance, fullInstance, onMutated }: InstanceCardProps) {
